...
\usepackage{lipsum} % Filler text; remove.
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{TITLE} % Replace TITLE with your title.
\fancyhead[R]{\nouppercase{\leftmark}}
\fancyfoot[C]{}
...
\renewcommand{\headrule}{
  ...
  \hbox to \headwidth{
    ...
    \hspace{5pt}
    \raisebox{0.20pt}{\pgfornament[width=1cm]{11}} % Replace with prefered ornament index
    \hspace{5pt}
    \leaders\hrule height 0.5pt\hfill
  }
}
...
\title{
    \textbf{TITLE} \\ % Replace TITLE with your title
}
\author{
  AUTHOR % Replace AUTHOR with your name
}
\date{}
